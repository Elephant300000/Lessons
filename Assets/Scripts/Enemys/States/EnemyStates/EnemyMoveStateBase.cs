...
{
    public EnemyMoveState(IStateHandler _stateHandler, IBehaviourHandler behaviourHandler, EnemyBase enemy) : base(_stateHandler, behaviourHandler, enemy)
    {
        Transitions();
        behaviours = new List<IBehaviourBase>()
        {
            behaviourHandler.Get<IEnemyRandomRotate>(),
            behaviourHandler.Get<IEnemyRandomMove>()
        };
    }
